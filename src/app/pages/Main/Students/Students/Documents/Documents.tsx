...
export const Documents = ({student}:any) => {
    const CHEF_NAME='Joao Sidonia Cardoso',
    CHEF_TITLE='Professora Auxiliar'
    return (<>
        <HtmlDocument>
            {html
            .replace('[FULL_NAME]',student?.person?.fullName.toUpperCase())
            .replace('[BIRTH_PLACE_ADDRESS]',student?.person?.birthPlaceAddress?.city+ ' ' +student?.person?.birthPlaceAddress?.province)
            .replace('[GRADE]',student?.enrollment?.classe?.grade)
            .replace('[NUMBER]',student?.code)
            .replace('[CHEF_NAME]',CHEF_NAME)
            .replace('[CHEF_TITLE]',CHEF_TITLE)
            .replace('[COURSE]','#AGRONOMIA')
            .replace('[DATE]',moment().format('DD [de] MMMM [de] YYYY'))
            }
        </HtmlDocument>
        </>)
}

const logo = `data:image/png;base64,iV
...
&nbsp;</p>
<p style="text-align: center;">REPUBLICA DE ANGOLA<br/>MINISTERIO DO ENSINO SUPERIOR<br/>INSITUTO SUPERIOR POLITECTNICO DO BENGO</p>

<h1 style="text-align: center;">DECLARAÇÃO</h1>
<p>N/Ref: 00252/2023</p>
<p>A faculdade acima citada do instituto Superior do Bengo declara que&nbsp; <b>[FULL_NAME]</b> natural de [BIRTH_PLACE_ADDRESS] frequenta&nbsp; o [GRADE]º Ano nesta faculdade o plano curicular&nbsp; da licenciatura do curso de [COURSE] matriculado sob o numero de estudante [NUMBER]</p>
<p>É tudo que me compete informar</p>
<p>Departamento de Assuntos academicos da faculdade do Instituto Superior do Bengo aos [DATE]</p>
<p style="text-align: center;">&nbsp;</p>
<p style="text-align: center;">&nbsp;</p>
<p style="text-align: center;">O Chefe de departamento</p>
<p style="text-align: center;">_____________________________</p>
<p style="text-align: center;">[CHEF_NAME]<br/>([CHEF_TITLE])</p>
<p>&nbsp;</p>
<p>&nbsp;</p>

<p style="text-align: center; font-size:5px">Instituto Superior do bengo, Avenida 22 de maio, Caxito, bengo - Angola<br/>
