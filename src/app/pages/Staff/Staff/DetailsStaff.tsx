...
export const DetailsStaff = () => {
  ...
  const tabsTitles = ['Detalhes', 'Documentos', 'Disciplinas', 'Turmas', 'Historicos']
  const Tabs = [DataStaff, DocumentStaffs, StaffDiscipline, HistoryStaffs, AssessmentStaffs, History][tab]
  return (
