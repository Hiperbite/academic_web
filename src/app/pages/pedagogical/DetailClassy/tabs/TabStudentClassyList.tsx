        ...
        <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <div className="table-responsive">
                <table className="table table-striped mg-b-0">
                    ...
                    <tbody>
                        {data?.data?.map((enrollment: any) => <tr onClick={() => navigate("/pedagogical/student/show/" + enrollment?.id)}>
            ...
            <EnrollmentConfirmations show={show} handleClose={handleClose} classy={classy} />
        </div>
    </>)
}


const EnrollmentConfirmations = ({ show, handleClose, classy }: any) => {

    const [student, setStudent] = useState<any>({})
    //const { data, loading, isError } = useAxiosFetch(services.student.students, { pageSize: 20 })
    const data={data:[]}
    const spanStyles = {
        'display': 'block',
        'color': '#999',
