...
import { useRegisterClassyData } from '../../api/pedagogical/classy';
import { useGetAcademicPeriodsData } from '../../api/pedagogical/academicPeriod';
import { useGetAcademicShiftsData } from '../../api/pedagogical/academicShift';
import { useGetClassyRoomsData } from '../../api/pedagogical/classyRoom';
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              <FloatingLabel
                ...
                >
                  <option value={undefined}>-</option>
                  {classyRooms?.map(({ id, code, size }: any) => <option value={id}>{code} - {size}</option>)}
                </Form.Select>
              </FloatingLabel>
