...
export const UpdatePeriod = () => {
  ...
  return (
    <div className="az-content-body pd-lg-l-40 d-flex flex-column">
      ...
      <h2 className="az-content-title">Actualizar Turno #{data?.code}</h2>
...
export const PeriodForm = ({ period }: any) => {
  ...
  const { put, data, loading, success, error } = useUpdateperiodData();
  ...
  const onSubmit = (form: any) => put({ ...form, ...{ id: period?.id } })
  useEffect(() => {
    reset(period);
  }, [period, reset]);
